...
# РЕАЛИЗАЦИЯ ТЕМЫ ВОПРОС 26: CGI: концепція диспетчера доступу (єдина точка входу)
# РЕАЛИЗАЦИЯ ТЕМЫ ВОПРОС 27: CGI: доступ до статичних ресурсів — способи, переваги, недоліки
# РЕАЛИЗАЦИЯ ТЕМЫ ВОПРОС 28: CGI: обмеження доступу до статичних ресурсів, медіа-типи, статус 415
# РЕАЛИЗАЦИЯ ТЕМЫ ВОПРОС 30: CGI: отримання інформації про помилки виконання
# РЕАЛИЗАЦИЯ ТЕМЫ ВОПРОС 31: CGI: огляд способів і традицій маршрутизації
...
# - ВОПРОС 01: CGI-SHEBANG И ПРИМЕР СКРИПТА ПОКАЗЫВАЮТ ИНТЕРПРЕТИРУЕМОЕ ВЫПОЛНЕНИЕ.
# - ВОПРОС 21: ЭТО CGI-ТОЧКА ВХОДА, КОТОРАЯ ФОРМИРУЕТ ОТВЕТ ЧЕРЕЗ STDOUT.
# - ВОПРОС 22: ФАЙЛ ДЕМОНСТРИРУЕТ ОСНОВНУЮ ИДЕЮ CGI: СЕРВЕР ВЫЗЫВАЕТ СКРИПТ ДЛЯ ЗАПРОСА.
# - ВОПРОС 23: ТРЕБОВАНИЯ CGI ВЫПОЛНЯЮТСЯ: SHEBANG, ЗАГОЛОВКИ, ВЫВОД В STDOUT.
# - ВОПРОС 24: ЧТЕНИЕ ПЕРЕМЕННЫХ ОКРУЖЕНИЯ (REQUEST_METHOD, PATH_INFO И Т.Д.).
# - ВОПРОС 25: НАСТРОЙКА STDOUT НА UTF-8 ДЛЯ КОРРЕКТНОЙ ОТДАЧИ.
# - ВОПРОС 26: FRONT CONTROLLER — ЕДИНАЯ ТОЧКА ВХОДА ДЛЯ МАРШРУТИЗАЦИИ ЗАПРОСОВ.
# - ВОПРОС 27: ОБРАБОТКА СТАТИЧЕСКИХ РЕСУРСОВ (ИМЕНА/ПУТИ) В ЭТОМ ФАЙЛЕ.
# - ВОПРОС 28: ПРОВЕРКИ CONTENT-TYPE И ОТКАЗ 415 ПОКАЗЫВАЮТ ОГРАНИЧЕНИЕ ДОСТУПА ПО МЕДИА-ТИПАМ.
# - ВОПРОС 30: ОБРАБОТКА ОШИБОК И СТАТУСЫ В ОТВЕТЕ ДЛЯ ДИАГНОСТИКИ.
# - ВОПРОС 31: РАЗБОР PATH_INFO И ДИНАМИЧЕСКИЙ ВЫБОР КОНТРОЛЛЕРА — ЭТО МАРШРУТИЗАЦИЯ.
# - ВОПРОС 32: ДИНАМИЧЕСКИЙ ИМПОРТ КОНТРОЛЛЕРОВ ПО СТРОКЕ МАРШРУТА.
# - ВОПРОС 38: ВЫБОР 401/403 В ОТВЕТАХ ПОКАЗЫВАЕТ СТАТУС-КОДЫ АВТОРИЗАЦИИ/ДОСТУПА.
#
