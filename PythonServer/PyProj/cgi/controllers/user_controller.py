...
#реализован контроллер /user Basic Auth > JWT

class UserController(RestController):

    def serve(self):
        # Базовая настройка метаданных REST-ответа
        # указывактся ссылки на методы API
    ...
    def do_get(self):
        ...
        # подробные проверки входных данных, чтобы явно показывать тип ошибок
        ...
        # именно Basic в начале заголовка
        ...
        # Base64 в строку "login:password"
        #стандартная форма для Basic Auth
        user_pass = None
        try:
        ...
        # iss должен соответствовать требованию ДЗ: "Server-KN-P-221" по условию)
        payload = {
