...
# Этот контроллер отвечает за главную страницу и за вывод параметров CGI.
...
class HomeController:
    ...
    def index(self):
        ...
        # Формируем HTML для анализа маршрута в формате /lang/Controller/Action/Id.
        # Это нужно для ДЗ №3 (включить результат анализа в HTML).
        # Анализ в виде таблицы — самый наглядный способ показать значения.
        ...
        # Подставляем готовые фрагменты в шаблон (простая HTML-строка).
    ...
    def params(self):
        ...
        # Формируем списки, чтобы удобно просматривать данные.
