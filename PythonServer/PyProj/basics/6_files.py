...
# РЕАЛИЗАЦИЯ ТЕМЫ ВОПРОС 10: Робота з файлами: операції з файлами та директоріями
# РЕАЛИЗАЦИЯ ТЕМЫ ВОПРОС 11: Робота з файлами: збереження даних і відновлення
####################################################################

# КЛЮЧЕВЫЕ МОМЕНТЫ ПО ТЕМАМ (КАПСОМ ДЛЯ БЫСТРОГО ПОИСКА):
# - ВОПРОС 03: РАБОТА С КОНТЕЙНЕРАМИ ПРИ ОБРАБОТКЕ ФАЙЛОВ ПОКАЗЫВАЕТ ПРАКТИКУ СТРУКТУР ДАННЫХ.
# - ВОПРОС 04: УСЛОВНЫЕ ПРОВЕРКИ И ЦИКЛЫ ПРИ ЧТЕНИИ/ЗАПИСИ ФАЙЛОВ ПОКАЗЫВАЮТ ВЕТВЛЕНИЕ/ПОВТОРЕНИЕ.
# - ВОПРОС 09: TRY/EXCEPT В ФАЙЛОВЫХ ОПЕРАЦИЯХ ПОКАЗЫВАЕТ ОБРАБОТКУ ОШИБОК ВВОДА/ВЫВОДА.
# - ВОПРОС 10: ОПЕРАЦИИ С ФАЙЛАМИ/ДИРЕКТОРИЯМИ (СОЗДАНИЕ, ПРОВЕРКА, ПЕРЕМЕЩЕНИЕ) — ОСНОВНЫЕ ФАЙЛОВЫЕ ДЕЙСТВИЯ.
# - ВОПРОС 11: ЗАПИСЬ/ЧТЕНИЕ ДАННЫХ В ФАЙЛЫ ПОКАЗЫВАЕТ СОХРАНЕНИЕ И ВОССТАНОВЛЕНИЕ ДАННЫХ.
#
