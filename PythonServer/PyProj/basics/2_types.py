...
# - ВОПРОС 01: ПОКАЗАНА ДИНАМИЧНАЯ ТИПИЗАЦИЯ — ТИПЫ ОПРЕДЕЛЯЮТСЯ ПО ЗНАЧЕНИЯМ ПЕРЕМЕННЫХ (I, F, S, B, N).
# - ВОПРОС 02: ЕСТЬ БАЗОВЫЕ ТИПЫ (INT/FLOAT/STR/BOOL/NONE) И ЯВНЫЕ ПРИВЕДЕНИЯ INT/FLOAT/STR/BOOL.
# - ВОПРОС 03: ПРИМЕРЫ СТРУКТУР ДАННЫХ LIST/TUPLE/SET/DICT И ИТЕРАЦИЯ ПО НИМ.
# - ВОПРОС 04: УСЛОВИЯ IF/ELIF/ELSE И ЦИКЛ FOR ДЕМОНСТРИРУЮТ РАЗГАЛУЖЕНИЕ И ПОВТОРЕННЯ.
#
