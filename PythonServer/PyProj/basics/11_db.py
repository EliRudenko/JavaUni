...
# - ВОПРОС 03: РЕЗУЛЬТАТЫ ЗАПРОСОВ ПРЕДСТАВЛЕНЫ КАК СТРУКТУРЫ ДАННЫХ (СПИСКИ/КОРТЕЖИ).
# - ВОПРОС 04: УСЛОВНЫЕ ПРОВЕРКИ ДЛЯ ВЕТВЛЕНИЯ ЛОГИКИ ПРИ РАБОТЕ С ДАННЫМИ.
# - ВОПРОС 09: TRY/EXCEPT В РАБОТЕ С БД ДЕМОНСТРИРУЕТ ОБРАБОТКУ ОШИБОК.
# - ВОПРОС 19: ПОДКЛЮЧЕНИЕ К БД ЧЕРЕЗ MYSQL.CONNECTOR И ПАРАМЕТРЫ ХОСТ/ПОРТ/ПОЛЬЗОВАТЕЛЬ.
# - ВОПРОС 20: ВЫПОЛНЕНИЕ SQL-ЗАПРОСОВ, ПАРАМЕТРОВ И ПОЛУЧЕНИЕ РЕЗУЛЬТАТОВ.
#
