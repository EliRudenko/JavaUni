...
# РЕАЛИЗАЦИЯ ТЕМЫ ВОПРОС 18: ORM: відображення даних на об’єкти у Python
####################################################################

# КЛЮЧЕВЫЕ МОМЕНТЫ ПО ТЕМАМ (КАПСОМ ДЛЯ БЫСТРОГО ПОИСКА):
# - ВОПРОС 14: КЛАССЫ И НАСЛЕДОВАНИЕ ИСПОЛЬЗУЮТСЯ ДЛЯ ООП-ПРИНЦИПОВ.
# - ВОПРОС 18: ПРИМЕР МОДЕЛИ И РАБОТЫ С ORM ПОКАЗЫВАЕТ СООТВЕТСТВИЕ ОБЪЕКТОВ И ТАБЛИЦ.
#
