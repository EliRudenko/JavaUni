...
public class Main
{
    public static void main(String[] args)
    {
        ...
        while (true) {
            ...
            System.out.println("4 - Полювати 🐭");
            System.out.println("5 - Миється 🧼");
            System.out.println("6 - Автопілот (кіт сам вирішує)");
            ...
            switch (choice) {
                ...
                case 4 -> cat.hunt();
                case 5 -> cat.wash();
                case 6 -> cat.liveOneCycle();
                case 0 -> {
                    System.out.println("Дякуємо за гру!");
                    return;
                }
                default -> System.out.println("Невірна команда. Введіть число від 0 до 6.");
            }
